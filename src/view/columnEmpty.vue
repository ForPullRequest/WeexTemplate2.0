...
export default{
    components: {
        columnT: require('../template/columnT.vue'),
    ...
    methods:{
        ...
        load(columnT) {
            modal.toast('load' + columnT.selectIndex)
            //模拟数据获取
            setTimeout(function() {
        ...
        columnRight(){
            // modal.alert("This is columnRight");
        },
        columnTitle(){
            // modal.alert("This is columnTitle");
        },
        // columnBack(){//customBack为true时可用
        //     modal.alert("columnBack");
        // },
    }
}
</script>