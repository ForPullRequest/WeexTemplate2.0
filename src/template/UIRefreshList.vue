<template>
    <div>
        ...
        <div v-if="!hasData" class="list center" @click="clickRefresh">
...
<script>
    ...
    module.exports = {
        ...
        methods: {
            getCacheTime() {
                cache.get('lastRefreshTime', function (ret) {
                    if (ret.data == null) {
                        return '';
                    } else {
            ...
            saveTime() {
                ...
                cache.save('lastRefreshTime', onlyDate, function () { });
            },
