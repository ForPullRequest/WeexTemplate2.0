...
<template>
    <!-- <div > -->
        <baseT :backItemImage="backItemImage" :barBackGroundColor="barBackGroundColor" :barTitleColor="barTitleColor" 
        :contentBackGroundColor="contentBackGroundColor" :rightItemColor="rightItemColor" 
        :title="title" :rightItemText="rightItemText" :rightItemImage="rightItemImage" 
        :isShow="isShow" :isIndex="isIndex" :customBack="customBack" @baseAppear="appear" 
